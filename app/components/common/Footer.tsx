        ...
        <div className="row footer">
          <div className="col-6 footer_cool">
            ...
            <p className="footer_cool__description">
              ...
              magnam id esse laboriosam deserunt tempore impedit nostrum
              consequuntur facere sunt perferendis et ea, illum placeat nam
              blanditiis ipsum veniam expedita.
            </p>
          </div>
          <div className="col-2">
            <h3>CONTACT US </h3>
